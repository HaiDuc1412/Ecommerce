...
/**
 * Spring Security configuration. Configures authentication, authorization,
 * CORS, and JWT filter.
 *
 * Note: In production with nginx proxy, CORS is handled by nginx. This CORS
 * config is for direct backend access (local dev, Swagger UI).
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    /**
     * CORS configuration for direct backend access. Supports both exact origins
     * and wildcard patterns (e.g., https://*.run.app).
     */
    @Bean
